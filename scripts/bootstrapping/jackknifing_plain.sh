...
run_toys_fit() {
    ...
    for i in $(seq $start_index $end_index); do
        ...
        setup_command="python $WREM_BASE/scripts/combine/setupCombine.py -i ${infile}_jackknife_sample_${i}.hdf5 -o ${outdir} --fitvar 'ptll-yll-cosThetaStarll_quantile-phiStarll_quantile' --fitAlphaS --baseName nominal --pseudoData asimov --postfix ${postfix}jackknife_sample_${i} --systematicType normal --pseudoDataScale 0.1"
...
run_toys_fit 1 30 "${MY_OUT_DIR}/250615_jackknife25_seed1861_eff0.1/mz_dilepton_jackknife25_seed1861" "${MY_OUT_DIR}/250615_jackknife25_seed1861_eff0.1/" "" ""
