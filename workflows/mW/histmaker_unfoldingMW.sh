...
command="python ${WREM_BASE}/scripts/histmakers/mw_with_mu_eta_pt.py --dataPath /scratch/submit/cms/wmass/NanoAOD/ -o $output_dir --maxFiles -1 --unfolding --poiAsNoi ${extra_args} ${postfix}"
