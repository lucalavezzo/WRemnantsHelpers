#!/bin/bash
# usage: run.sh <logfile> <cmd...>   (copy of ../260910-blinding/scripts/run.sh)
D=/home/submit/lavezzo/alphaS/WRemnantsHelpers/studies/scetlib-ad-param-model/260910-wall-port/scripts
