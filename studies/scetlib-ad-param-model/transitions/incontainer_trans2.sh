...
# build-anltrans2. scetlib-cms, build-fix, build-knots, build-trans, build-nak,
# build-5knot and build-anlmuf are NOT touched.
set -e
source /opt/venv/bin/activate
source /home/submit/lavezzo/alphaS/WRemnants/setup.sh > /dev/null
export SCETLIB_BUILD=/work/submit/lavezzo/alphaS/scetlib-anltrans/build-anltrans2
