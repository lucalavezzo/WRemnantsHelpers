...
# $1 = threads, $2 = ad_muf_abl mask for the analytic arm (the residual-form
# field lives in bits 7..9), $3 = out subdir
set -u
...
OUT=$HOME/public_html/alphaS/260826_transition_safe_interp/closure/${3:-form}
...
$SING $D/incontainer_safeint.sh python3 -u $D/trans_closure.py \
