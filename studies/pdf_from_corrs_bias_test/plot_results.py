...
def parse_args():
    ...
    parser.add_argument(
        "--central-pdfs",
        nargs="+",
        choices=list(DEFAULT_CENTRAL_PDFS.keys()),
        default=list(DEFAULT_CENTRAL_PDFS.keys()),
        metavar="PDF",
    ...
    parser.add_argument(
        "--pseudodata-pdfs",
        nargs="+",
        choices=list(DEFAULT_PSEUDODATA_PDFS.keys()),
        default=list(DEFAULT_PSEUDODATA_PDFS.keys()),
        metavar="PDF",
...
def main():
    ...
    for central_pdf in args.central_pdfs:
        ...
        for pseudodata_pdf in args.pseudodata_pdfs:
            result = f"nominal_{DEFAULT_PSEUDODATA_PDFS[pseudodata_pdf]}_Corr_vars"
    ...
    # scatter plot
    colors = build_cms_color_cycle(len(args.pseudodata_pdfs))
