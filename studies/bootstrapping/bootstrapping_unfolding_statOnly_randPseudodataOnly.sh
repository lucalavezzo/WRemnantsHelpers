...
run_toys_fit() {
    ...
    for seed in ${seeds[@]}; do
        ...
        unfolding_command="combinetf2_fit.py ${unfolding_setup_output} -o $(dirname ${unfolding_setup_output}) --binByBinStatType normal -t 10 --toysSystRandomize none --toysDataRandomize poisson --computeHistCov --saveHists --computeHistErrors -m Select ch0_masked --seed ${seed} --postfix ${seed}"
...
run_toys_fit "${MY_OUT_DIR}/250516_toys_34567/mz_dilepton.hdf5" "${MY_OUT_DIR}/250525_toys_unfolding_statOnly_toy0/"
